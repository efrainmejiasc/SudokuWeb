                        ...
                        <asp:Panel ID="Pnl1" runat="server" CssClass="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <asp:Label ID="Label2" runat="server" Text="" CssClass="font-weight-bold"><%= Resources.NuevoUserPassword.aspx.txtUsuario %></asp:Label>
                                    <asp:TextBox ID="txtUsuario" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <asp:Label ID="Label3" runat="server" Text="" CssClass="font-weight-bold"><%= Resources.NuevoUserPassword.aspx.txtPasswordUser %></asp:Label>
                ...
                <div class="col-md-6 offset-md-3 my-5">
                    <div class="card">
                        <asp:Panel ID="Pnl2" runat="server" CssClass="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <asp:Label ID="Label6" runat="server" Text="" CssClass="font-weight-bold"><%= Resources.NuevoUserPassword.aspx.txtPassword %></asp:Label>
                                    <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <asp:Label ID="Label7" runat="server" Text="" CssClass="font-weight-bold"><%= Resources.NuevoUserPassword.aspx.txtPassword2 %></asp:Label>
